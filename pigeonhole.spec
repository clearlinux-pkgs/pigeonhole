...
#
Name     : pigeonhole
Version  : 2.3.pigeonhole.0.5.17.1
Release  : 7
URL      : https://pigeonhole.dovecot.org/releases/2.3/dovecot-2.3-pigeonhole-0.5.17.1.tar.gz
Source0  : https://pigeonhole.dovecot.org/releases/2.3/dovecot-2.3-pigeonhole-0.5.17.1.tar.gz
Source1  : https://pigeonhole.dovecot.org/releases/2.3/dovecot-2.3-pigeonhole-0.5.17.1.tar.gz.sig
...
%prep
%setup -q -n dovecot-2.3-pigeonhole-0.5.17.1
cd %{_builddir}/dovecot-2.3-pigeonhole-0.5.17.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643521257
...
cp %{_builddir}/dovecot-2.3-pigeonhole-0.5.17.1/COPYING %{buildroot}/usr/share/package-licenses/pigeonhole/e54ccad100241cf089ed3934f148d2ac2db470fd
cp %{_builddir}/dovecot-2.3-pigeonhole-0.5.17.1/COPYING.LGPL %{buildroot}/usr/share/package-licenses/pigeonhole/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
